...
$(document).ready(function(){
	 var button = $('<input  class="showH1" class="submit" type="submit" name="showH1" value="Click here to see the introduction and instructions" />');
...
<h1 class="shadow" style="font-size: 36px" id=""> Seeker Homepage</h1><div class="underline"></div>
<h1 id="blurb" style="margin: 1em 0 1em 2em; background-color: #192535; border-radius: 10px; padding: 2em; color: #ffffff">
Thank you for choosing the IT, Networking, Cybersecurity Job/Internship Matching Program <?php echo INC; ?> <br> </br><?php echo INC; ?> matches you, the job seeker, with potential employers. Take a few minutes to explore the site to see what options are available to you. <br>
...
//We are deleting job preferences from the database
	if(isset($_GET['submit'])){
		...
		if($query){
			header("location: " . SKRHOME . "?id=" . $_SESSION['cwwid']);
...
<?php 
//echo "<script> alert($('div').length)</script>";
require("publicfooter.php"); ?>
