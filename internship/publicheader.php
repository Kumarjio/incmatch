...
<div class="small_screen">
	<a href="index.php"><img class="image" src="images/CWW.png" alt="cyberwatch west logo" width="250" /></a>
	<div style="padding: .2%">
<h1 class="menuss" id="welcome" style="color: #000000">
	...
	<?php if($_SESSION['cwwid']){ ?>
		<li class="menuss"><a href="http://cwwinternship.cyberwatchwest.org/internship/home.php?id=<?php echo $_SESSION['cwwid']; ?>">Home</a></li>		
		<li class="menuss"><a href="jobpref.php">Set Preference</a></li>		
		<li class="menuss"><a href="cwwemployers.php">Participating Employers</a></li>
		<li class="menuss"><a href="startresume.php">Create Resume</a>
			<div class="hider">
				<a href="http://cwwinternship.cyberwatchwest.org/internship/viewresume.php?id=<?php echo $_SESSION['cwwid']; ?>">View Resume</a>
