...
<div class="conatain">
	...
	<a href="https://cyberwatchwest.org"><img class="image" src="images/CWW.png" alt="cyberwatch west logo" width="150" /></a>
	<div style="padding: .2%; margin: 0 0 0 10%">
	<h2 class="menuss" style="color: #ffffff"> WELCOME <br><?php echo strToUpper($_SESSION['full']); ?></h2><br></br>
		...
		<li class="menuss"><a href="yourarea.php?<?php echo $_SESSION['id']; ?>">Candidates in Your Area</a></li>
